...
const faqData = [
  {
    ...
    answer: 'Uygulamamızdaki otobüs saatleri ve konum verileri, belediye ulaşım ağından anlık olarak çekilmektedir. Trafik durumuna göre sapmalar canlı olarak haritada gösterilir.'
  },
  {
    id: 2,
    question: 'Hatalı veya eksik bir durak/hat gördüm, ne yapmalıyım?',
    answer: 'Hatalı olduğunu düşündüğünüz durak veya hat bilgilerini aşağıdaki "Bize Ulaşın" butonlarını kullanarak ekran görüntüsüyle birlikte bize iletebilirsiniz. En kısa sürede güncellenecektir.'
  },
  {
    id: 3,
...
export default function HelpSupportScreen() {
  ...
  // İletişim Kanallarına Yönlendirme Fonksiyonları
  const openEmail = () => {
    Linking.openURL('mailto:destek@gumusrota.com?subject=Gümüş-Rota Destek Talebi');
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.supportChannels}>
          ...
          <TouchableOpacity style={styles.channelCard} onPress={openEmail}>
            <View style={[styles.iconCircle, { backgroundColor: '#FFE9ED' }]}>
              <Ionicons name="mail-outline" size={24} color="#FF2D55" />
            </View>
            <Text style={styles.channelLabel}>E-Posta Gönder</Text>
            <Text style={styles.channelSub}>destek@gumusrota.com</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.channelCard} onPress={openPhone}>
